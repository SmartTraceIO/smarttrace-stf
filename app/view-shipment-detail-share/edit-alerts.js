    ...
    VM.getShipment = function() {
        webSvc.getShipment(VM.shipmentId).success(function(data) {
            if (data.status.code == 0) {
                ...
                VM.shipment.noAlertsAfterArrivalMinutes = VM.shipment.noAlertsAfterArrivalMinutes ? VM.shipment.noAlertsAfterArrivalMinutes.toString() : '';
                VM.shipment.noAlertsAfterStartMinutes = VM.shipment.noAlertsAfterStartMinutes ? VM.shipment.noAlertsAfterStartMinutes.toString() : '';
